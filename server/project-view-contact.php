<?php
	...
	echo "<div id=\"view-contacts\">";
								...
								WHERE relatedcontact.project = $contid";
								...
								if(mysqli_num_rows($rcontact) > 0){
									...
									echo "<h4>No Contacts Added! Why not add some? Select \"Add Contacts\" to attach existing ones to this project, or select \"New Contact\" to add a new one for this client.</h4>";
								}
							echo "</div>";
?>