<?php
	...
	if(isset($_REQUEST['contact'])){
		echo "<section id=\"address-new\">
			<article>
				<form action=\"server/new-contact-submit.php\" method=\"post\" enctype=\"multipart/form-data\">
					<div>
					...
					<div>
						...
						<input type=\"submit\" name=\"create-new\" value=\"Add Contact\">
					</div>
				</form>
			</article>
		</section>
		<script src=\"https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js\"></script>
		<script src=\"server/js/address-new.js\"></script>";
	}
?>